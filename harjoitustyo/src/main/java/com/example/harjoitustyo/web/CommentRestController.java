...
public class CommentRestController {
    ...
    public CommentRestController(CommentRepository cRepository, AppUserRepository auRepository,
    ...
    public Comment postComment(@RequestBody Comment comment) {
        if (comment.getCommentId() != null) {
            ...
            throw new CustomBadRequestException("Wrong or missing AppUser Id");
                ...
                || !cRepository.findById(comment.getLocation().getLocationId()).isPresent()) {
    ...
    public Optional<Comment> putComment(@RequestBody Comment newComment, @PathVariable Long id) {
        if (!cRepository.findById(id).isPresent()) {
            ...
            throw new CustomBadRequestException("Wrong or missing AppUser Id");
                ...
                || !cRepository.findById(newComment.getLocation().getLocationId()).isPresent()) {
            throw new CustomBadRequestException("Wrong or missing Location Id");
        }
